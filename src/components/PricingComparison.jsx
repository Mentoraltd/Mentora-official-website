...
const PricingPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {/* --- HERO SECTION --- */}
      <section className="bg-gradient-to-b from-gray-50 via-white to-gray-100 py-16 px-4 sm:px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button className="bg-gray-200 text-black font-bold px-6 py-3 rounded-full hover:bg-gray-300 transition">
            Enter Your Email
          </button>
        </div>
        ...
        <div className="w-full max-w-7xl">
          ...
          <div className="flex justify-center mb-10 sm:mb-12">
            <div className="bg-gray-200 p-2 rounded-full flex">
              ...
              <button className="px-6 py-2 rounded-full bg-gray-400 text-black font-semibold hover:bg-gray-600 transition">
                Pay yearly (save 25%)*
              </button>
            </div>
          </div>
...
<section className="bg-white py-16 px-4 sm:px-6">
  <div className="max-w-5xl mx-auto">
    ...
    <div className="space-y-6">
      ...
      <motion.section
  className="bg-gradient-to-b from-gray-50 via-white to-gray-100 py-16 px-6 mt-10 text-center text-gray-800"
...
>
  ...
  <button className="bg-white text-black font-bold px-8 py-4 rounded-full hover:bg-gray-200 transition">
    Get Started for Free
      ...
      {/* --- FOOTER --- */}
      <footer className="bg-gradient-to-b from-gray-50 via-white to-gray-100 text-center text-gray-500 py-6 text-xs sm:text-sm mt-8">
